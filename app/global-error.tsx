      ...
      <body style={{ margin: 0, fontFamily: 'system-ui, sans-serif' }}>
        <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem', background: '#FAF8F4' }}>
          <div style={{ textAlign: 'center', maxWidth: '24rem' }}>
            ...
            <p style={{ color: '#6B6560', fontSize: '0.875rem', marginBottom: '1rem' }}>A critical error occurred. Please refresh the page.</p>
            {error?.digest && <p style={{ color: '#9E9994', fontSize: '0.75rem', marginBottom: '1.5rem', fontFamily: 'monospace' }}>Error ID: {error.digest}</p>}
